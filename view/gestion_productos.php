    ...
    <html lang="en">
        ...
        <body>
            ...
            <main id="main" class="main">
                ...
                <section id="main-section" class="section dashboard">
                    <div class="row m-0"> 
                                    ...
                                    <div class="text-center col-12 col-md-3 fs-4 rounded-2 card">
                                        ...
                                        <?php if ($r_categoria == 1 ): ?>
                                            ...
                                            <div class="text-center mb-2">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#registrar_categoria" class="mb-2 btn btn-success">
                                        ...
                                        <?php endif; if ($l_categoria == 1 ): ?>
                                            ...
                                            <div class="text-center mb-2">
                                                <button onclick="getList_category()" id="btn_ver_listas_categoria" type="button" class=" btn btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalList">
                        ...
                        <div class="col-12 mb-3 pagetitle text-center">
                            <div class="card rounded-2 p-2">
                                <div class="car-body row p-3 justify-content-center">
                                    
                                    <h2 id="titulo_productos" class="border-2 border-bottom border-success fw-bold mb-4 mt-3 text-center text-success"><i class="bi bi-check-circle"></i> Lista de productos Activos</h2>

                                    <?php if ($r_productos && $l_productos): ?>

                                        <div class="setCol text-center col-md-6 col-12 mb-3">
                                            <button data-bs-target="#registrar_producto"  data-bs-toggle="modal" id="btn-toggle" type="button" class=" btn btn-success">
                                    ...
                                    <?php if ($l_productos == 1 ): ?>
                                        ...
                                        <div id="tableListProducts" class="justify-content-between align-items-center table table-responsive">
                                            ...
                                            <table class="table tableActivos mb-3 table-striped" id="tableActivos">
                                                <thead>
                                                    <tr>
