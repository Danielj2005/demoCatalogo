...
<main style="display:none !important;" class="main">
...
<div class="flex items-center justify-center min-h-[60vh] p-4">
    <form method="POST" action="controller/login.php" data-type-form="load" autocomplete="off" onsubmit="handleLogin()" class="text-center bg-[#020617] border border-slate-800 p-8 rounded-[2.5rem] w-full max-w-sm shadow-2xl">
        ...
        <input name="user" type="text" placeholder="Cédula" required class="w-full p-2 rounded-2xl mb-4 text-black outline-none ring-purple-500 focus:ring-2">
        <input name="pass" type="password" placeholder="Contraseña" required class="w-full p-2 rounded-2xl mb-6 text-black outline-none ring-purple-500 focus:ring-2">
